...
def NOTIFIED_ADD_CONTACT(op):
    try:
        sendMessage(op.param1, client.getContact(op.param1).displayName + "Jual Followers Murah! \n\n 1000 Folls : Rp 15.000 \n 1000 Likers : Rp 5.000 \n 1000 Views : Rp 5.000 \n\n Pembayaran :\n - Via Pulsa\n - Via Bank \n\n Thankyou!")
...
def NOTIFIED_KICKOUT_FROM_GROUP(op):
    try:
        sendMessage(op.param1, client.getContact(op.param3).displayName + " Good Bye Jeleks \n(*´･ω･*)")
    except Exception as e:
        print e
